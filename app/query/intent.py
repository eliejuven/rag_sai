...
- "search" if the user is asking about financial statements, revenues (receita), profits (lucro), EBITDA, balance sheets (balanço), debts (dívida), dividends (dividendos), or other accounting/document-based data from regulatory filings.
